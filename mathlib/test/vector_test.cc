...
namespace UnitTest {
  ...
  void Vec2Test() {
    ...
    oxml::Vec2 test;
    oxml::Vec2 another_test = oxml::Vec2(1.5f, 2.5f);
    oxml::Vec2 copy(another_test);
    bool worked = false;
    ...
    another_test = oxml::Vec2(1.5f, 2.5f);
    another_test.Normalize();
    worked = oxml::Vec2(0.51449f, 0.85749f) == another_test;
    ...
    another_test = oxml::Vec2(1.5f, 2.5f);
    worked = oxml::Vec2(0.51449f, 0.85749f) == another_test.Normalized();
    ...
    another_test = oxml::Vec2(1.5f, 2.5f);
    another_test.Scale(oxml::Vec2(2.0f, 2.0f));
    worked = oxml::Vec2(3.0f, 5.0f) == another_test;
    Assert::AreEqual(true, worked, "Scale Failed", __FILE__, __LINE__);

    //Check SqrMagnitude function.
    another_test = oxml::Vec2(1.5f, 0.5f);
    Assert::AreEqual(2.5f, another_test.SqrMagnitude(), "SqrMagnitude Failed", __FILE__, __LINE__);
  
    //Check Distance function.
    another_test = oxml::Vec2(0.5f, 1.5f);
    test = oxml::Vec2(1.5f, 2.5f);
    Assert::AreEqual(1.414214f, oxml::Vec2::Distance(test, another_test), 0.0001f, "Distance failed", __FILE__, __LINE__);

    //Check Lerp function.
    another_test = oxml::Vec2(0.5f, 1.5f);
    test = oxml::Vec2(1.5f, 2.5f);
    another_test = oxml::Vec2::Lerp(another_test, test, 0.7f);
  ...
  void Vec3Test() {
    ...
    oxml::Vec3 test;
    oxml::Vec3 another_test = oxml::Vec3(0.5f, 1.5f, 2.5f);
    oxml::Vec3 a = oxml::Vec3(5.0f, 3.0f, 2.0f);
    oxml::Vec3 b = oxml::Vec3(3.0f, 2.0f, 1.0f);
    ...
    //Check Normalize function.
    another_test = oxml::Vec3(0.5f, 1.5f, 2.5f);
    another_test.Normalize();
    ...
    //Check Lerp function.
    another_test = oxml::Vec3::Lerp(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), 0.5f);
    ...
    another_test = oxml::Vec3::Lerp(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), 1.5f);
    ...
    another_test = oxml::Vec3::Lerp(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), -1.0f);
    ...
    another_test = oxml::Vec3::LerpUnclamped(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), 0.5f);
    ...
    another_test = oxml::Vec3::LerpUnclamped(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), 1.5f);
    ...
    another_test = oxml::Vec3::LerpUnclamped(oxml::Vec3(0.0f, 1.0f, 2.0f), oxml::Vec3(1.0f, 2.0f, 3.0f), -1.0f);
    ...
    //Check Distance function
    Assert::AreEqual(10.246951f, oxml::Vec3::Distance(oxml::Vec3(7, 4, 3), oxml::Vec3(17, 6, 2)), 0.000001f, "Distance Failed", __FILE__, __LINE__);

    //Check Reflect function
    another_test = oxml::Vec3::Reflect(oxml::Vec3(-0.5f, 0.5f, 0), oxml::Vec3(-1, 0, 0));
    ...
    //Check Scale function.
    another_test = oxml::Vec3(1.0f, 2.0f, 3.0f);
    another_test.Scale(oxml::Vec3(2.0f));
  ...
  void Vec4Test() {
    ...
    oxml::Vec4 test;
    oxml::Vec4 a = oxml::Vec4(5.0f, 3.0f, 2.0f, 1.0f);
    oxml::Vec4 b = oxml::Vec4(3.0f, 2.0f, 1.0f, 0.0f);
    ...
    test = oxml::Vec4::Lerp(oxml::Vec4(0.0f), oxml::Vec4(1), 1.5);
    ...
    test = oxml::Vec4::Lerp(oxml::Vec4(0.0f), oxml::Vec4(1), -1);
